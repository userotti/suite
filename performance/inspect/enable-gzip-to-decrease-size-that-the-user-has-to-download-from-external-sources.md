...
```
###
# Enable GZIP, see http://passmarked.com/performance/inspect/enable-gzip-to-decrease-size-that-the-user-has-to-download-from-external-sources for more details.
###
gzip on;
